...
import skuber.model.{ReplicationController, Scale}
...
package object ext {
  ...
  type HorizontalPodAutoscaler = skuber.model.autoscaling.HorizontalPodAutoscaler
  ...
  type HorizontalPodAutoscalerList = skuber.model.autoscaling.HorizontalPodAutoscalerList
