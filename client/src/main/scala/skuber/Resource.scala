...
object Resource {
  ...
  object Quota {
    ...
    implicit val rqDef: ResourceDefinition[Quota] = new ResourceDefinition[Resource.Quota] {
      def spec: CoreResourceSpecification = specification
    }
    implicit val rqListDef: ResourceDefinition[ResourceQuotaList] = new ResourceDefinition[ResourceQuotaList] {
      def spec: CoreResourceSpecification = specification
    }
