...
package object ext {
  ...
  @deprecated(
    "Use type 'skuber.autoscaling.HorizontalPodAutoscaler' instead of 'skuber.ext.HorizontalPodAutoscaler'",
    "Skuber 1.7"
  )
  type HorizontalPodAutoscaler = skuber.autoscaling.HorizontalPodAutoscaler
  @deprecated(
    "Use type 'skuber.autoscaling.HorizontalPodAutoscalerList' instead of 'skuber.ext.HorizontalPodAutoscalerList'",
    "Skuber 1.7"
  )
  ...
  class ExtensionsGroupAPI(val context: K8SRequestContext) {
     ...
     */
    @deprecated(message = "Use method scale[ReplicationController](name,count) instead")
    def scaleReplicationController(name: String, count: Int)(
    ...
    def scaleReplicaSet(name: String, count: Int)(
        implicit lc: LoggingContext = RequestLoggingContext()
    ): Future[Scale] =
     ...
     */
    @deprecated(message = "Use method scale[Deployment](name,count) instead")
    def scaleDeployment(name: String, count: Int)(
        implicit lc: LoggingContext = RequestLoggingContext()
    ): Future[Scale] =
    ...
    def getDeploymentScale(objName: String)(implicit lc: LoggingContext = RequestLoggingContext()): Future[Scale] =
      context.getScale[skuber.apps.Deployment](objName)
    ...
    def getReplicationControllerScale(
        objName: String
    )(implicit lc: LoggingContext = RequestLoggingContext()): Future[Scale] =
      context.getScale[ReplicationController](objName)
    ...
    def getReplicaSetScale(objName: String)(implicit lc: LoggingContext = RequestLoggingContext()): Future[Scale] =
      context.getScale[ReplicaSet](objName)
  }
