...
object RoleBinding {
  ...
  implicit val roleDef: ResourceDefinition[RoleBinding] = new ResourceDefinition[RoleBinding] {
    def spec: NonCoreResourceSpecification = specification
  }
  implicit val roleListDef: ResourceDefinition[RoleBindingList] = new ResourceDefinition[RoleBindingList] {
    def spec: NonCoreResourceSpecification = specification
  }
}
