...
object CustomResourceDefinition {
  ...
  implicit val namesFormat: OFormat[apiextensions.CustomResourceDefinition.Names] = (
  ...
  )(CustomResourceDefinition.apply, unlift(CustomResourceDefinition.unapply))
