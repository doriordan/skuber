...
package object format {
  ...
  )(Deployment.Status.apply, d => (d.replicas, d.updatedReplicas, d.availableReplicas, d.unavailableReplicas, d.observedGeneration))
  ...
  )(Deployment.RollingUpdate.apply, r => (r.maxUnavailable, r.maxSurge))
  ...
  )(Deployment.Strategy.apply, d => (d._type, d.rollingUpdate))
  ...
  )(Deployment.Spec.apply, d => (d.replicas, d.selector, d.template, d.strategy, d.minReadySeconds))
