...
Support of non-core API group functionality is pretty extensive, in particular of the more popular/important features. Deployment, ReplicaSet, Autoscaling, Job, Ingress, DaemonSet and RBAC are all currently supported on the master branch. Support for other alpha/beta Kubernete features is being added all the time.
