...
/**
  ...
  */
private[pekkoclient] object BytesToWatchEventSource {
  def apply[O <: ObjectResource](client: PekkoKubernetesClientImpl, bytesSource: Source[ByteString, _], bufSize: Int, errorHandlerOpt: Option[String => _] = None)(implicit ec: ExecutionContext, format: Format[O], lc: LoggingContext): Source[WatchEvent[O], _] = {
