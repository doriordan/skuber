...
object Watch {
  ...
  /**
    ...
    * @return
    */
  def events[O <: ObjectResource](context: PekkoKubernetesClientImpl, name: String, sinceResourceVersion: Option[String] = None, bufSize: Int, errorHandler: Option[String => _])(
